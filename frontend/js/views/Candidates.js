            ...
            <div class="card card-g-12">
                <div class="card-header" style="justify-content: space-between; align-items: center; display: flex;">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <button id="btn-upload-candidates" class="action-btn" style="padding: 0.75rem 1.25rem; border-radius: 8px; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 0.5rem;">
